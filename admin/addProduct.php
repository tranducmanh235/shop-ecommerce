  ...
  include "config.php";
    ...
    if (isset($_FILES['fileToUpload']))
    {
        ...
        if ($_FILES['fileToUpload']['error'] > 0)
        {
          ...
          $result = mysqli_query($mysqli, "INSERT INTO sanpham (MaLSP,TenSP,DonGia,SoLuong,HinhAnh,MaKM,Details,SoSao,SoDanhGia,TrangThai) VALUES('$MaLSP','$TenSP','$DonGia','$SoLuong','$HinhAnh','$MaKM','$Details','$SoSao','$SoDanhGia','$TrangThai')");
          //redirectig to the display page.
          header("Location: manageProduct.php");
        }
    }
        ...
        <div class="row">
			<div class="col-lg-12">
				...
				<div class="card-header d-flex align-items-center">
					<h3 class="h4">Thêm sản phẩm mới</h3>
				</div>
				<div class="card-body">
					...
					<div class="col-lg-6 form-group">
						...
						<input type="text" placeholder="Mã lớp sản phẩm" name="MaLSP" class="form-control">
					</div>
					<div class="col-lg-6 form-group">       
						<label class="form-control-label">Tên sản phẩm</label>
						<input type="text" placeholder="Tên sản phẩm" name="TenSP" class="form-control">
					</div>
					...
					<div class="col-lg-6 form-group">       
						...
						<input type="text" placeholder="Số lượng" name="SoLuong" class="form-control">
					</div>
          <div class="col-lg-6 form-group">       
            ...
            <input type="file" name="fileToUpload" id="fileToUpload" class="form-control">
					...
					<div class="col-lg-6 form-group">       
						...
						<input type="text" placeholder="Mã Khuyến mãi" name="MaKM" class="form-control">
					</div>
					<div class="col-lg-6 form-group">       
						<label class="form-control-label">Chi tiết</label>
						<input type="text" placeholder="Chi tiết" name="Details" class="form-control">
					</div>
					<div class="col-lg-6 form-group">       
						<label class="form-control-label">Số sao</label>
						<input type="text" placeholder="Số sao" name="SoSao" class="form-control">
					</div>
					<div class="col-lg-6 form-group">       
						<label class="form-control-label">Số đánh giá</label>
						<input type="text" placeholder="Số đánh giá" name="SoDanhGia" class="form-control">
					</div>
					<div class="col-lg-6 form-group">       
						<label class="form-control-label">Trang thai</label>
						<input type="text" placeholder="Trang thai" name="TrangThai" class="form-control">
					</div>
					<div class="col-lg-6 form-group"> 
