...
function showMiniCard(data, listQuantity) {
    ...
    for (var i = 0; i < data.length; i++) {
        result += `
        <li>
            <a href="view/single-product-sale.php?id=${data[i].MaSP}" class="minicart-product-image">
                <img style="width: 48px; height: 48px" src="${data[i].HinhAnh}" alt="cart products">
            </a>
            <div class="minicart-product-details">
                <h6><a href="view/single-product-sale.php?id=${data[i].MaSP}">${data[i].TenSP}</a></h6>
